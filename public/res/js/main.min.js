!function(e, t) {
    ...
    x.fn = x.prototype = {
            ...
            if (h && !i) {
                ...
                if (r.qsa && (!g || !g.test(e))) {
                    if (m = d = b, y = t, x = 9 === l && e, 1 === l && "object" !== t.nodeName.toLowerCase()) {
                        for (c = bt(e), (d = t.getAttribute("id")) ? m = d.replace(nt, "\\$&") : t.setAttribute("id", m), 
                        m = "[id='" + m + "'] ", u = c.length; u--; ) c[u] = m + xt(c[u]);
        ...
        function pt(e, t, n) {
            e = e.split("|");
            for (var r, i = e.length, a = n ? null : t; i--; ) (r = o.attrHandle[e[i]]) && r !== t || (o.attrHandle[e[i]] = a);
        }
        function ft(e, t) {
        ...
        function Nt(e, t, n, r, i, o) {
            return r && !r[b] && (r = Nt(r)), i && !i[b] && (i = Nt(i, o)), ut(function(o, a, s, l) {
                ...
                if (n && n(m, y, s, l), r) for (u = Ct(y, d), r(u, [], s, l), c = u.length; c--; ) (p = u[c]) && (y[d[c]] = !(m[d[c]] = p));
                if (o) {
                    if (i || e) {
                        if (i) {
        ...
        function kt(e) {
            for (var t, n, r, i = e.length, a = o.relative[e[0].type], s = a || o.relative[" "], l = a ? 1 : 0, c = wt(function(e) {
                return e === t;
            }, s, !0), p = wt(function(e) {
                return F.call(t, e) > -1;
            }, s, !0), f = [ function(e, n, r) {
                return !a && (r || n !== u) || ((t = n).nodeType ? c(e, n, r) : p(e, n, r));
            } ]; i > l; l++) if (n = o.relative[e[l].type]) f = [ wt(Tt(f), n) ]; else {
        ...
        s = at.isXML = function(e) {
            ...
            h = !s(n), i && i.frameElement && i.attachEvent("onbeforeunload", function() {
                p();
        ...
        l = at.compile = function(e, t) {
            var n, r = [], i = [], o = E[e + " "];
            if (!o) {
                for (t || (t = bt(e)), n = t.length; n--; ) o = kt(t[n]), o[b] ? r.push(o) : i.push(o);
                o = E(e, Et(i, r));
            }
            return o;
        }, o.pseudos.nth = o.pseudos.eq, jt.prototype = o.filters = o.pseudos, o.setFilters = new jt(), 
        r.sortStable = b.split("").sort(A).join("") === b, p(), [ 0, 0 ].sort(A), r.detectDuplicates = S, 
    ...
    x.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return this.each(x.isFunction(e) ? function(n) {
                x(this).toggleClass(e.call(this, n, this.className, t), t);
            } : function() {
                if ("string" === n) for (var o, a = 0, s = x(this), l = t, u = e.match(T) || []; o = u[a++]; ) l = r ? l : !s.hasClass(o), 
                s[l ? "addClass" : "removeClass"](o); else (n === i || "boolean" === n) && (this.className && x._data(this, "__className__", this.className), 
    ...
    $.fn.bxSlider = function(options) {
        ...
        return el.goToSlide = function(slideIndex, direction) {
            ...
            slider.oldIndex = slider.active.index, slider.active.index = 0 > slideIndex ? getPagerQty() - 1 : slideIndex >= getPagerQty() ? 0 : slideIndex, 
    ...
    $.flexslider = function(el, options) {
        ...
        $.data(el, "flexslider", slider), methods = {
            ...
            touch: function() {
                ...
                el.addEventListener("MSGestureChange", onMSGestureChange, !1), el.addEventListener("MSGestureEnd", onMSGestureEnd, !1)) : (onTouchStart = function(e) {
    ...
    function callBxSlider() {
        $(".slide-in").bxSlider(768 >= widthWindow ? {
            slideWidth: 5e3,
            minSlides: 1,
            maxSlides: 1,
            slideMargin: 0,
    ...
    callBxSlider(), $(".toggle-imoveis").click(function() {
        var target = $(this).data("content");
        $(this).toggleClass("is-active"), $('[data-target="' + target + '"').toggleClass("is-active");
    }), $("#carousel").flexslider({
        animation: "slide",
        controlNav: !1,
        animationLoop: !1,
